...
public enum MobInfo {
  ...
  CONCUSSION_CREEPER(EntityConcussionCreeper.class, EntityConcussionCreeper.NAME, EntityConcussionCreeper.EGG_BG_COL, EntityConcussionCreeper.EGG_FG_COL,
      Config.concussionCreeperEnabled, Config.concussionCreeperHealth, 4),
  FALLEN_KNIGHT(EntityFallenKnight.class, EntityFallenKnight.NAME, EntityFallenKnight.EGG_BG_COL, EntityFallenKnight.EGG_FG_COL, 
      Config.fallenKnightEnabled, Config.fallenKnightHealth, Config.fallenKnightBaseDamage),
  FALLEN_MOUNT(EntityFallenMount.class, EntityFallenMount.NAME, EntityFallenMount.EGG_BG_COL, EntityFallenMount.EGG_FG_COL, 
      Config.fallenMountEnabled, Config.fallenMountHealth, Config.fallenMountBaseAttackDamage),
  WITHER_WITCH(EntityWitherWitch.class, EntityWitherWitch.NAME, EntityWitherWitch.EGG_BG_COL, EntityWitherWitch.EGG_FG_COL, 
      Config.witherWitchEnabled, Config.witherWitchHealth, 4),
